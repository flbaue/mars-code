...
public class WriteUtil {
    ...
    public static void writeFile(final List<Ticket> tickets, final String site) throws IOException {
    ...
    private WriteUtil(final List<Ticket> t, final String s) throws IOException {
    ...
    private void writeValues(final HSSFSheet worksheet) {
        ...
        for (int ticketI = 0; ticketI < tickets.size(); ticketI++) {
            ...
            Row row = worksheet.createRow(iRow);
    ...
    private void createHeadlines(final HSSFSheet worksheet, final String type) {
