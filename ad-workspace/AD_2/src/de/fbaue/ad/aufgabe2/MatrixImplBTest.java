...
public class MatrixImplBTest {
	...
	matrixA1 = new MatrixImplB(valuesA);
	matrixA2 = new MatrixImplB(valuesA);
	valuesB = MatrixGeneratorUtil.randomMatrix(n, 0, 10, 90);
	matrixB1 = new MatrixImplB(valuesB);
	matrixB2 = new MatrixImplB(valuesB);
	valuesC = MatrixGeneratorUtil.randomMatrix(n, 0, 10, 90);
	matrixC1 = new MatrixImplB(valuesC);
	matrixC2 = new MatrixImplB(valuesC);
    }
