...
public class Client {
    ...
    public void sendMessage(String text) {
        Message message = new Message(MessageCommand.TEXT, text, new fbaue.messenger.common.Client(null, port_incoming));
    ...
    public void connectToServer(String host, int port, String secretToken) {
        server.setHost(host);
        server.setPort(port);
        Message message = new Message(MessageCommand.LOGIN, secretToken, new fbaue.messenger.common.Client(null,
                port_incoming));
        sendQueue.add(message);
    }
